 ...
 */
import { WeatherData, ForecastPoint, GPXData } from '@shared/types';
import { ApiResponse, WeatherApiResponse as BaseWeatherApiResponse, GpxApiResponse as BaseGpxApiResponse } from './api-response';

// Re-export base API response types
 ...
 */
export interface WeatherApiResponse extends BaseWeatherApiResponse<(WeatherData | null)[]> {
 ...
 */
export interface GpxUploadResponse extends BaseGpxApiResponse<GPXData> {
 ...
 */
export interface RouteSettingsResponse
  extends ApiResponse<{
    /** The route ID */
    routeId: string;
