...
import { getWeatherForecast, getMultipleForecastPoints, ForecastPoint, WeatherData } from '@backend/lib/weatherAPI';
import { ApiResponse, WeatherApiRequest, WeatherApiResponse } from '@shared/types/api-types';
