      ...
      <div className={cn(layout.flexCol, 'h-full min-h-screen')}>
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Plan your routes with detailed weather forecasts</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <div className={cn(layout.flexCol, 'flex-1 container mx-auto px-4 py-6 gap-6')}>
          ...
          <div className="w-full">
            <SimpleGPXUploader onGPXLoaded={handleGPXLoaded} isLoading={isLoading || isGenerating} />
          </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <label htmlFor="weather-interval" className="text-sm font-medium">Interval (km)</label>
                      <input
                        id="weather-interval"
                        type="number"
                    ...
                    <div>
                      <label htmlFor="avg-speed" className="text-sm font-medium">Speed (km/h)</label>
                      <input
                        id="avg-speed"
                        type="number"
                        value={avgSpeed}
              ...
              <Card className="max-w-md mx-auto">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your route will appear on the map with detailed weather information along the way.
                  </p>
                </CardContent>
              </Card>
            </div>
