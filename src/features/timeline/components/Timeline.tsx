...
// Import from utils
import { formatTime, formatDistance, formatTemperature, formatWind, getWeatherIconUrl, checkWeatherAlerts } from '@/utils/formatUtils';
    ...
    <Card className="mt-4 relative">
      <CardContent className="p-4">
        ...
        <div className="w-full overflow-hidden">
          <div
            className={`timeline-scrollable-area flex space-x-2 py-2 px-4 overflow-x-auto scrollbar-thin whitespace-nowrap ${isDragging ? 'cursor-grabbing' : 'cursor-grab'}`}
