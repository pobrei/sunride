...
import { GPXData, RoutePoint } from '@shared/utils/gpxParser';
...
import { StatusIndicator } from '@frontend/components/ui/status-indicator';
...
import { effects, animation, typography } from '@shared/styles/tailwind-utils';
