...
import { formatTime, formatDistance, formatTemperature } from '@shared/utils/formatters';
      ...
      <CardContent>
        <div className="relative h-[200px] w-full bg-muted/20 rounded-md overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center">
            <LoadingSpinner
              message="Temperature chart visualization coming soon"
              variant="pulse"
              size="md"
            />
          </div>
          ...
          <div className="absolute bottom-2 left-2 right-2 bg-background/80 p-2 rounded-md text-xs">
            <div className="font-medium mb-1">Temperature Data:</div>
