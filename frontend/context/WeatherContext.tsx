...
import { GPXData, generateForecastPoints } from '@shared/utils/gpxParser';
import { ForecastPoint, WeatherData } from '@backend/lib/weatherAPI';
import { fetchWeatherForPoints } from '@backend/lib/mongodb-api';
import { captureException, captureMessage } from '@shared/lib/sentry';
import { useNotifications } from '@frontend/components/NotificationProvider';
import { useSafeData } from '@frontend/components/SafeDataProvider';
