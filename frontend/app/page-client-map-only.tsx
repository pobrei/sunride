...
// Dynamically import the SimpleMapWrapper component with no SSR
const SimpleMapWrapper = dynamic(() => import('@/components/map/SimpleMapWrapper'), {
  ssr: false,
  loading: () => (
...
const SimpleTimelineWrapper = dynamic(() => import('@/components/timeline/SimpleTimelineWrapper'), {
  ssr: false,
  loading: () => (
...
const SimpleChartsWrapper = dynamic(() => import('@/components/charts/SimpleChartsWrapper'), {
  ssr: false,
  loading: () => (
