...
import { SafeMapWrapper } from '@frontend/components/map';
import { SafeTimelineWrapper } from '@frontend/components/timeline';
import { SafeChartsWrapper } from '@frontend/components/charts';
