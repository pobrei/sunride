...
import { ChartContainer } from '@frontend/components/charts';
...
import { NotificationProvider } from '@frontend/components/providers';
...
jest.mock('@frontend/components/charts/TemperatureChart', () => {
  return {
    __esModule: true,
...
jest.mock('@frontend/components/charts/PrecipitationChart', () => {
  return {
    __esModule: true,
    default: ({ forecastPoints, weatherData, selectedMarker, onChartClick }) => (
...
jest.mock('@frontend/components/charts/WindChart', () => {
  return {
    __esModule: true,
    default: ({ forecastPoints, weatherData, selectedMarker, onChartClick }) => (
...
jest.mock('@frontend/components/charts/HumidityChart', () => {
  return {
    __esModule: true,
...
jest.mock('@frontend/components/charts/PressureChart', () => {
  return {
    __esModule: true,
...
jest.mock('@frontend/components/charts/ElevationChart', () => {
  return {
    __esModule: true,
...
jest.mock('@frontend/components/charts/UVIndexChart', () => {
  return {
    __esModule: true,
